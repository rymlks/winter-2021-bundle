...
namespace Assets
{
    public class DBCharacter : IDbfElement
    {
    ...
    public class DBDate : IDbfElement
    {
        public DbfFieldDiscriptor discriptor { get; set; }
    ...
    public class DBFloat : IDbfElement
    {
        public DbfFieldDiscriptor discriptor { get; set; }
    ...
    public class DBLogical : IDbfElement
    {
        public DbfFieldDiscriptor discriptor { get; set; }
    ...
    public class DBMemo : IDbfElement
    {
        public DbfFieldDiscriptor discriptor { get; set; }
    ...
    public class DBNumeric : IDbfElement
    {
        public DbfFieldDiscriptor discriptor { get; set; }
        public char[] Value { get; set; }
