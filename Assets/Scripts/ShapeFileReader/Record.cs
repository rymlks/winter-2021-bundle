...
namespace Assets
{
    ...
    public class DbfRecord : IRecord
    {
        ...
        public List<IDbfElement> Record { get; set; }

        public DbfRecord(List<DbfFieldDiscriptor> fieldList)
        {
            FieldList = fieldList;
            Record = new List<IDbfElement>();
        }
        ...
        public void Load(ref BinaryReader br)
        {
            ...
            {
                IDbfElement element = DataFactory.CreateInstance(fd);
                element.Load(ref br);
                Record.Add(element);
            }
        }
    ...
    {
        public static readonly IDictionary<DBFFieldType, Func<DbfFieldDiscriptor, IDbfElement>> Creators =
            new Dictionary<DBFFieldType, Func<DbfFieldDiscriptor, IDbfElement>>()
            {
        ...
        public static IDbfElement CreateInstance(DbfFieldDiscriptor fd)
        {
